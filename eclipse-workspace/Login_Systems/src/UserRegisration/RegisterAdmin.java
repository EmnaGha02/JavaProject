...
public class RegisterAdmin {
	...
	private void initialize() {
		...
		lblRegisterAsDoctor = new JLabel("Register as an Admin ");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                ...
                if ( Password!= "admin" || id !="admin" ) {
                	...
                	JOptionPane.showMessageDialog(btnNewButton, "Enter a valid ID and assword , they should be both Admin !!  ");
                }

                try {
                    Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/swing_demo", "root", "root");
                     //store into accountAdmin
                    
                    String query = "INSERT INTO accountAdmin values('" + cin + "','" + fullname + "','" + id + "','" +
                        Password + "','" + Mail + "','" + "')";
